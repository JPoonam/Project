...
typedef enum {
       ...
       //
    BHReportFilterWarningSigns,// this option for headache only! 
    BHReportFilterLocation, 
    ...
    BHScreenFilterRow_Diet,
     BHScreenFilterRow_Lifestyle,
//    BHScreenFilterRow_Lifestyle_And_Menstruation,
   // BHScreenFilterRow_Menstruation,
